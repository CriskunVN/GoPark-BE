...
const signAccessToken = (id: Types.ObjectId | string) => {
  const expiresIn = '15m';
...
const signRefreshToken = (id: Types.ObjectId | string) => {
...
const createSendToken = async (
  ...
  const uid = typeof user._id === 'string' ? user._id : (user._id as string);
